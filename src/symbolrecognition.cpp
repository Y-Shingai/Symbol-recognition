...
RTC::ReturnCode_t symbolrecognition::onExecute(RTC::UniqueId ec_id)
{
	//Template Image
	Mat tmp_imgs[4];
	tmp_imgs[0] = imread("C:/Users/VŠKK–ç/workspace/Symbol recognition/src/houkou/mae.png", 1);
	tmp_imgs[1] = imread("C:/Users/VŠKK–ç/workspace/Symbol recognition/src/houkou/usiro.png", 1);
	tmp_imgs[2] = imread("C:/Users/VŠKK–ç/workspace/Symbol recognition/src/houkou/hidarisenkai.png", 1);
	tmp_imgs[3] = imread("C:/Users/VŠKK–ç/workspace/Symbol recognition/src/houkou/migisenkai.png", 1);
